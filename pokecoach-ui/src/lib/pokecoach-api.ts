...
import type { PokecoachMoveRequest, PokecoachRequest, SelectedPokemon, TeamEvalResponse } from "../types/Pokemon.types";
...
export async function getTeamEval(requestBody: PokecoachRequest): Promise<TeamEvalResponse> {
    const response = await fetch(`${API_BASE_URL}/pokecoach/eval`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
